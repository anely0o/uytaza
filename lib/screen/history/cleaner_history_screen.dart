/// lib/screen/history/cleaner_history_screen.dart
import 'dart:convert';
...
/// Screen for cleaner: shows only finished orders with rating and reviews
    ...
    return Scaffold(
      ...
      body: _loading
        ...
        child: _finishedOrders.isEmpty
            ? Center(
          child: Text('No finished orders yet.', style: TextStyle(color: TColor.textSecondary)),
        )
            : ListView.builder(
